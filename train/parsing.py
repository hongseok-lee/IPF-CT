...
def parse_args(args_strings=None):
    ...
    parser.add_argument(
        ...
        help="Name of lr scheduler [default: onecyclelr]",
    )
    ...
    parser.add_argument(
        ...
        help="Name of mask interpolation [default: area]",
    )
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            'sybil_volume',
            'sybil_plus_volume',
            'sybil_plus_volume_survival',
            'sybil_plus_volume_survival_mtl',
            'sybil_plus_volume_survival_detach',
            'sybil_plus_volume_survival_detach_double_density',
        ],
        help="select model type [default: sybil]",
    )
    ...
    parser.add_argument(
        ...
        help="multiselect pool type [default: 123]",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="gaussian random crop from centroid",
    )
    parser.add_argument(
        "--random_crop_sigma",
        default=0.1,
        type=float,
        help="sigma of gaussian random crop from centroid",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="use weak loss about annotation volume"
    )
    ...
    parser.add_argument(
        '--load_pretrain_path',
        default='/data1/IPF_CT/Sybil/sybil_ckpts/sybil/models/28a7cd44f5bcd3e6cc760b65c7e0d54depoch=10.ckpt',
        type=str,
    )
    ...
    #TODO: design the parser for the following: guess reticular, honeycomb, fibrosis, total and other combinations. 
    # TODO: decide between proportion to total image voxels, or total lung volume(Cc)
    # parser.add_argument(
    #     "--guess_volume",
    #     action="store_true",
    #     default=False,
    #     help="model train the volumes",
    # )
    ...
    parser.add_argument(
        ...
        choices=[
            'fibrosis_proportion',
            'honeycomb_proportion',
            'normal_proportion',
            'reticular_proportion',
            'cropped_fibrosis_density',
            'cropped_lung_density',
            'cropped_fibrosis_proportion',
            'cropped_normal_proportion',
            'cropped_normal_density',
            # "fibrosis_volume",
            # "reticular_volume",
            # "honeycomb_volume",
            # 'total_lung_volume',
        ],
        help="multiselect prediction target volumes type [default: []]",
    )
    ...
    parser.add_argument(
        ...
        # required=True,
        default=[],
        help="volume prediction lambda, in order (fib, honey, norm, retic) [default: []]",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='111',
        help="x, y, z(slice; slice_thickness(mm))",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Dynamic annotation loss lambda (decrease in linear)"
    )
