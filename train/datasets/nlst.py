...
class NLST_Survival_Dataset(data.Dataset):
    def __init__(self, args, split_group):
        ...
        # [HS] A variable "transformer" is not used in this class. 
        ...
        try:
            self.metadata_json = json.load(open(args.dataset_file_path, "r")) # /path/to/json_dir/nlst_dataset.json
        ...
        if args.use_annotations:
            ...
            self.annotations_metadata = json.load(
                open(self.args.region_annotations_filepath, "r") # /path/to/annot_dir/annotations_122020.json 
            )
    ...
    def create_dataset(self, split_group):
        ...
        for mrn_row in tqdm(self.metadata_json, position=0): # nlst metadata_json is required. 
